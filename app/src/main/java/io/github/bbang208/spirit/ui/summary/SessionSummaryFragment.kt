...
import io.github.bbang208.spirit.databinding.FragmentSessionSummaryBinding
...
@AndroidEntryPoint
class SessionSummaryFragment : DistractionAwareFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnDone.setOnClickListener {
            findNavController().navigate(R.id.action_sessionSummary_to_home)
        }

        binding.btnSave.setOnClickListener {
            // TODO: Upload session to server (Phase 5)
            findNavController().navigate(R.id.action_sessionSummary_to_home)
        }
    }
